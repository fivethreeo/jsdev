...
ALLOWED_HOSTS = ['.levangersundet.no', 'fivethreeo.pythonanywhere.com', '.elasticbeanstalk.com']


# Application definition

ROOT_URLCONF = 'levangersundet.urls'


WSGI_APPLICATION = 'levangersundet.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'levangersundet', 'static'),
)
SITE_ID = 1
...
if 'AWS_STORAGE_BUCKET_NAME' in os.environ:
    ...
    STATICFILES_STORAGE = 'levangersundet.custom_storages.StaticStorage'
    DEFAULT_FILE_STORAGE = 'levangersundet.custom_storages.MediaStorage'
...
TEMPLATES = [
    ...
    'DIRS': [os.path.join(BASE_DIR, 'levangersundet', 'templates')],
    'OPTIONS': {
        'context_processors': [
