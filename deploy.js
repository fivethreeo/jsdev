...
var REGIONS =  ['us-east-1', 'us-west-2', 'eu-west-1', 'ap-northeast-1'];
var RESOURCE_DIR = path.join(__dirname, 'node_modules', 'cfn-elasticsearch-domain');
var CFN_LAMBDA_DIR = path.join(__dirname, 'node_modules', 'cfn-elasticsearch-domain', 'node_modules', 'cfn-lambda', 'lib');
